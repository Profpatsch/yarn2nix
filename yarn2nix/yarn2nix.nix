...
, tasty-th, template, template-haskell, text, transformers, unix
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    protolude regex-tdfa stm template template-haskell text
  ...
  testHaskellDepends = [
    ...
    tasty-quickcheck tasty-th template template-haskell text
    transformers unordered-containers yarn-lock
  ];
  prePatch = "hpack";
